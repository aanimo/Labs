...
namespace lab9
{
    public partial class Form1 : Form
    {
        ...
        private int selectedIndex = -1; // Индекс выбранной строки в ListView
        ...
        private void ConfigureListView()
        {
            ...
            listViewStudents.SelectedIndexChanged += ListViewStudents_SelectedIndexChanged; // Обработчик выбора строки
        }
        ...
        private void ConfigureComboBox()
        {
            ...
            comboBoxFormat.SelectedIndex = 0; // Default to JSON
            ...
            comboBoxSpecification.SelectedIndex = 0; // Default
        }
        ...
        private void ListViewStudents_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listViewStudents.SelectedItems.Count > 0)
            {
                ...
                // Подставляем данные в элементы управления
            ...
            {
                // Если ничего не выбрано, сбрасываем поля ввода
                selectedIndex = -1;
